...
export function EyeIcon({ open, ...props }) {
  ...
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a17.9 17.9 0 0 1-3.09 4.09M6.3 6.3C3.4 8.1 1 12 1 12s4 8 11 8a9.6 9.6 0 0 0 5.7-1.8M1 1l22 22" />
      <path d="M14.12 14.12a3 3 0 1 1-4.24-4.24" />
    </svg>
  );
}

// Упрощённая, не пиксель-в-пиксель версия — только для распознаваемости
// кнопки "Continue with Google", без копирования официального ассета.
